...
# Load data ------------------------
matches_df = pd.read_csv('web/web_data/clean_wta_matches.csv')
players_df = pd.read_csv('web/web_data/clean_wta_players.csv')
...
with st.sidebar:
    ...
    run_simulation = st.button('Run simulation', key='run_simulation', type='primary')
