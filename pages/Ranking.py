...
with atp_tab:
    if run_simulation:
        ss['atp_matches_df'], ss['atp_ranking'], ss['atp_nofiltered_ranking'], ss['atp_elo_history'] = sim.simulate_atp_tour(ss['atp_matches_df'], ss['atp_players_df'], k, ksi, s, initial_elo, min_games, 'Tots', rmv_retired)
...
with wta_tab: 
    if run_simulation:
        ss['wta_matches_df'], ss['wta_ranking'], ss['wta_nofiltered_ranking'], ss['wta_elo_history'] = sim.simulate_wta_tour(ss['wta_matches_df'], ss['wta_players_df'], k, ksi, s, initial_elo, min_games, 'Tots', rmv_retired)
